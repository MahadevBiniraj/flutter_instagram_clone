...
class LikesListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: type == 'mentioned' || postsUrls.length > 1
              ...
              child: Column(
                ...
                children: [
                  if (type == 'liked' || type == 'mentioned')
                    if (postsUrls.length > 1) const SizedBox(height: 10),
                  Text.rich(
                    TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text: type == 'liked'
                              ? ' liked ${postsUrls.length > 1 ? '${postsUrls.length} posts' : 'your photo'}.'
                              : type == 'mentioned'
